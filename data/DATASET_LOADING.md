English | [简体中文](DATASET_LOADING.zh-CN.md)
...
- NUS-WIDE-TC10: [Baidu Netdisk](https://pan.baidu.com/s/1mlCVxiSsjp7pcQeQQX-yDw), password: `ru9j`
...
Keeping these folder names unchanged is enough because the repository already includes the corresponding loading logic.
